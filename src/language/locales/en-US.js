export default {
  ...
  kolAdd: {
    ...
    desc: "Note: Once the preliminary review is passed, the project will enter the community voting phase. The effective voting period is 7 days, and SBTC community members can participate in the voting to recommend the project. If the project receives 100 votes, it will gain listing rights, and related contracts will be automatically deployed.",
    tips: [
  ...
  messageTip:
    "Available only to the authenticated Inscription Community, your address is not authorized.",
