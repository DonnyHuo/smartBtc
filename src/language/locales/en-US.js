export default {
  home: {
    ...
    desc2: [
      "Submit KOL certification by having an active Twitter or other social media account and staking at least 2100 BRC20;",
      ...
      "Token airdrop allocation weights are calculated based on Twitter follower count, engagement with certified tweets (views, comments, likes, and retweets), actual BRC20 staked, and considering Telegram and Discord follower counts and activity levels.",
    ],
    ...
    dispositDesc:
      "Unstaking BRC20 will immediately terminate your KOL certification, and reapplication will not be allowed. Please proceed with caution.",
    liftDisposit: "Unstake",
    title3: ["Cross-chain Bridge", "BRC20 Governance and Buyback"],
    navTitle3: "Vote on BRC20 projects and stake BRC20 for project airdrops.",
    desc3: [
      "50% of BRC20 tokens on the BSC chain are issued to the cross-chain bridge contract, allowing active BRC20 inscription accounts to transfer cross-chain; 30% is issued through LP swaps as rewards for liquidity providers (LP); 18% is airdropped to KOLs who promote community development; and 2% is issued to the startup pool contract.",
      "SmartBTC regularly uses website income and project airdrops to buy back BRC20 and transfer it to the cross-chain bridge contract, increasing cross-chain capacity until 100% is reached. Once fully activated, cross-chain operations will be enabled both ways.",
    ],
    ...
    desc4: [
      {
        time: "March 9, 2023",
        desc: "Deployment of the first BRC20 inscription with BTC characters using the Ordinals protocol.",
      },
      {
        time: "May 12, 2023",
        desc: "The total supply of 21 million BRC20 was minted in batches of 500, involving nearly 2000 addresses.",
      },
      {
      ...
      {
        time: "April 26, 2024",
        desc: "The SmartBTC.io mainnet was officially launched, opening the first cross-chain asset BRC20, offering SWAP trading, launching LP staking mining pools, and introducing perpetual options with Bitcoin index inscriptions as premiums.",
      },
      {
        time: "May 10, 2024",
      ...
      },
      {
        ...
        desc: "During the Token2049 conference in Singapore, SmartBTC.io launched version 2.0, continuing to integrate rich DeFi applications and gradually opening services to active Bitcoin inscriptions, making BRC20 one of the top 3 mainstream inscriptions by market cap.",
      },
      {
        time: "2025",
        desc: "SmartBTC will gradually become compatible with mainstream BTC L2 and expand from BRC20 inscriptions to the entire Bitcoin ecosystem. BRC852 will become the mainstream asset issuance protocol, and SmartBTC.io will become a core application in the Bitcoin ecosystem, with BRC20 becoming the leading inscription.",
      },
    ],
  ...
  voting: {
    ...
    desc: "The project team (KOL) can refer to the BRC20 governance and buyback plan. During the project’s operational development, tokens circulating on the BSC chain can be continuously bought back and transferred into the cross-chain bridge contract, increasing the cross-chain capacity until 100%.",
  ...
  kol: {
    ...
    contentDesc: [
      ...
      "2. When submitting a claim, SmartBTC.io will comprehensively evaluate factors such as the amount of BRC20 staked by the KOL, the activity level of social accounts, the views, likes, and retweets of the certification tweet, the historical dynamics of social accounts related to the project, and the token holdings of the claimed address to automatically calculate the KOL's corresponding community airdrop reward allocation weight through algorithms;",
      ...
      "4. Claims can be revoked at any time to recover the staked BRC20. Once revoked, KOL rights will be terminated immediately and cannot be reapplied for reinstatement;",
    ...
    approve: "Authorize",
    despositBRC20: "Stake BRC20",
    balance: "Balance",
    inputNumber: "Please enter the staking amount",
    max: "Max",
    tweet:
      "My wallet {address} has staked BRC20 and is submitting KOL certification on the SmartBTC.io platform, participating in promoting the inscription of {name}. Please like and retweet this post to help {name} get trending on SmartBTC!",
    ...
    tips: [
      ...
      "The staking amount must be greater than or equal to {minDeposit} BRC20",
  ...
  kolAdd: {
    ...
    brc20Name: "Inscription Characters",
    brc20Id: "Inscription Deployment ID",
    brc20Supply: "Total Inscription Supply",
    ...
    desc: "Note: Once the preliminary review is passed, the project will enter the community voting phase. The effective voting period is 7 days, and BRC20 community members can participate in the voting to recommend the project. If the project receives 100 votes, it will gain listing rights, and related contracts will be automatically deployed.",
    tips: [
  ...
  community: {
    ...
    share: [
      ...
      "3. CoinDAO members import the 100T wallet into the downloaded OKX, migrating cross-chain to the BSC chain; BRC20 users transfer cross-chain to BSC",
