export default {
  home: {
    ...
    desc2: [
      "擁有活躍的Twitter等社交帳戶，並質押至少2100個BRC20，即可提交KOL認證；",
      "通過KOL認證，即可發起項目投票或選擇上幣項目，推廣項目以獲得代幣空投獎勵；",
      "根據推特粉絲數，認證推文的閱讀、評論、按讚和轉發數，以及實際質押的BRC20數量，並參考Telegram、Discord帳戶粉絲數和活躍度，綜合計算綁定項目的代幣空投分配權重。",
    ],
    kolBtn: "KOL認證",
    startProject: "發起项目",
    review: "审核",
    dispositNumber: "質押數量",
    dispositDesc:
      "解除BRC20質押，將即時終止KOL資格，且不可申請複效，謹慎操作。",
    liftDisposit: "解除質押",
    title3: ["跨鏈橋Bridge", "BRC20治理與回購"],
    navTitle3: "持有BRC20项目投票，質押BRC20项目空投。",
    desc3: [
      "BSC鏈的BRC20 代幣50%發行至跨鏈橋合約，以供活躍的BRC20銘文帳戶跨鏈轉移；30%以LP兌換的方式智能合約發行，即獎勵給流動性提供者（LP）；18%以空投的方式獎勵給參與社區推廣建設的KOL；2%發行至啟動池合約。 ",
      "SmartBTC定期以網站收入和项目空投所得回購BRC20並轉入跨鏈橋合約，不斷啟動跨鏈額度直至100%，全部啟動後，雙向跨鏈同步生效。",
    ],
    title4: "技術路線圖",
    navTitle4:
    ...
    desc4: [
      {
        time: "2023年3月9日",
        desc: "Ordinals協定首個帶有BTC字元的銘文BRC20部署發布",
      },
      {
        time: "2023年5月12日",
        desc: "總量2100萬，單次500的BRC20被全部Mint近2000個地址參與",
      },
      {
        time: "2024年1月13日",
      ...
      {
        time: "2024年4月26日",
        desc: "主網SmartBTC.io 正式發布，開通第一個跨鏈資產BRC20，提供SWAP交易，推出流動池LP質押挖礦，上線以比特幣為指數銘文為權利金的永續選擇權 ",
      },
      {
        time: "2024年5月10日",
      ...
      {
        time: "2024年下半年",
        desc: "新加坡Token2049會議期間，SmartBTC.io發布2.0版本，SmartBTC繼續整合豐富的DeFi應用，逐步向活躍比特幣銘文開放服務，BRC20成為市值TOP3主流銘文",
      },
      {
        time: "2025年",
        desc: "SmartBTC逐步相容主流BTC L2，並由BRC20(銘文)擴展到比特幣全生態，BRC852成為主流資產發行協議，SmartBTC.io成為比特幣生態底層應用，BRC20成為銘文新龍頭",
      },
    ],
    myProject: "我的項目",
  ...
  voting: {
    ...
    issuanceNumber: "發行數量",
    issuanceRatio: "發行比例",
    desc: " 專案方（KOL）可以藉鏡BRC20治理與回購方案，在專案營運發展中，不斷回購BSC鏈流通中的代幣轉入跨鏈橋合約，提高跨鏈額度直至100%。",
    ...
    voteTips: [
      "現行投票規則：",
      "投票有效期限7天，投票門檻1 BRC20，投票完成門檻100票",
    ],
    voteSuccess: "投票成功",
  },
  noData: "暫無數據",
  ...
  kol: {
    ...
    twitter: "Twitter地址",
    desc1:
      "發布Twitter認證推文，包含SmartBTC、BRC20和想認領的銘文項目信息，文案自定義，主要考察該推文24小時閱讀數、轉發數和點贊數。",
    telegram: "Telegram地址",
    discord: "Discord地址",
    submit: "提交认证",
    submitDesc:
      "KOL貢獻分配權重計算方法：初始權重主要取決於社交帳戶總粉絲數、認證推文24小時活躍度和實際質押的BRC20數量這三大維度，運營中不定期抓取認證社交帳戶（Twitter為主，Telegram、Discord為輔）對認領銘文项目與SmartBTC平台的關注與推廣數據，根據演算法提高KOL貢獻分配權重。",
    kolReview: "KOL审核中...",
    desposit: "去质押",
    search: "输入项目名称搜索",
    startPro: "发起项目",
    desc: [
      "認領和創建项目前，需要質押BRC20，數量2100個起，質押越多，分配權重越高，可以隨時撤銷質押。",
    ...
    contentDesc: [
      ...
      "2.提交認領時，SmartBTC.io會多維度測算KOL的質押BRC20數量、社交帳戶活躍度、認證推文閱讀點讚轉發數、社交帳戶歷史動態與項目的關聯度、認領地址項目代幣持倉數量等綜合因素，透過演算法自動計算出當前KOL對應的社群空投獎勵分配權重；",
      "3.一個KOL（對應認證的錢包位址）只能唯一認領一個項目，且認領完成不可更改；",
      "4.可以隨時撤銷認領，解除收回質押的BRC20，一經解除KOL權益即時終止且不可申請複效；",
    ...
    claimRule: "認領規則",
    approve: "去授權",
    despositBRC20: "质押BRC20",
    balance: "餘額",
    inputNumber: "請輸入質押數量",
    max: "最大",
    tweet:
      "我的錢包{address}已經質押BRC20，正在SmartBTC.io平台提交KOL認證，參與推廣{name}銘文，請大家幫忙點讚、轉發這則推文，助力{name}銘文上SmartBTC熱門！",
  ...
  kolAdd: {
    ...
    submit: "提交初審",
    desc: "說明：計畫初審通過後，將進入社區投票階段，有效投票期7天，持有BRC20社群會員可參與投票推薦，滿100票取得上市權益，自動部署相關合約。",
    tips: [
      "請填寫BSC代幣字符",
      "發行{name}项目",
      "確認是否已發推文且以目前按讚數提交申請",
  ...
  community: {
    ...
    share: [
      ...
      "3. CoinDAO会员把100T钱包导入下载的OKX，迁移跨链到BSC链；比特币铭文BRC20用户跨链转账到BSC",
