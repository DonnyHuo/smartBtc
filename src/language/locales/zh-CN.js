export default {
  home: {
    ...
    liftDisposit: "解除質押",
    title3: ["跨鏈橋Bridge", "SOS治理與回購"],
    navTitle3: "持有SOS项目投票，質押SOS项目空投。",
    desc3: [
      "BSC鏈的SOS 代幣50%發行至跨鏈橋合約，以供活躍的SOS銘文帳戶跨鏈轉移；30%以LP兌換的方式智能合約發行，即獎勵給流動性提供者（LP）；18%以空投的方式獎勵給參與社區推廣建設的KOL；2%發行至啟動池合約。 ",
